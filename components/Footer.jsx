...
export default function Footer() {
  ...
  const address = settings?.address || 'Jl. Albasia 3 Perum Papan Indah No 29 Rt 09/RW 09,\nMangunjaya, Tambun Selatan,\nKab. Bekasi, Jawa Barat'
  ...
  const renderIcon = (name) => {
    ...
    return <span className="font-bold text-xs">{name.charAt(0)}</span>
  }
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-slate-400">
              ...
              <li><Link href="/contact" className="hover:text-blue-400 transition-colors">Pertanyaan (FAQ)</Link></li>
              <li className="pt-2">

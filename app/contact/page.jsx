      ...
      <section className="relative z-10 pb-16">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-slate-800/40 border border-slate-700/50 backdrop-blur-md rounded-2xl p-6 hover:-translate-y-1 transition-all"><div className="text-rose-400 bg-rose-500/10 border-rose-500/20 w-14 h-14 rounded-xl flex items-center justify-center border mb-5"><MapPinIcon className="h-7 w-7" /></div><h3 className="text-lg font-bold text-slate-100 mb-3">Alamat</h3><p className="text-slate-300 text-sm">Perum Papan Indah No 29, Bekasi</p></div>

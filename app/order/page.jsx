                  ...
                  {uploadedFile ? (
                    ...
                    <div className="py-6">
                      ...
                      <div className="mt-6 flex flex-wrap justify-center gap-2 text-xs font-medium text-slate-400">
                        ...
                        <span className="px-2 py-1 bg-slate-800 rounded">PSD</span>
                      </div>
                    </div>
                  )}
                </div>
              ...
              <div className="animate-in fade-in slide-in-from-right-8 duration-500">
                ...
                <div className="bg-slate-800/50 border border-slate-700 rounded-2xl p-5 mb-10 shadow-inner">
                  ...
                  {formData.paymentMethod === 'BANK_TRANSFER' && (
                    <p className="text-slate-300 text-sm leading-relaxed">
                      Anda memilih Transfer Bank Reguler. Nomor rekening tujuan <strong>(BCA & Mandiri a.n PT Xlbk Customwear)</strong> akan ditampilkan secara detail di halaman selanjutnya setelah pesanan Anda berhasil dibuat.
                    </p>
                  )}
